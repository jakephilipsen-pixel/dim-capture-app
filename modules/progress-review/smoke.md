...
```bash
# From project root
./scripts/smoke-module.sh progress-review
```
...
4. Runs the smoke tests in `modules/progress-review/smoke/`
5. Tears down
...
`modules/progress-review/smoke/` — convention:
