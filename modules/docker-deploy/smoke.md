...
```bash
# From project root
./scripts/smoke-module.sh docker-deploy
```
...
4. Runs the smoke tests in `modules/docker-deploy/smoke/`
5. Tears down
...
`modules/docker-deploy/smoke/` — convention:
