...
```bash
# From project root
./scripts/smoke-module.sh frontend-scaffold
```
...
4. Runs the smoke tests in `modules/frontend-scaffold/smoke/`
5. Tears down
...
`modules/frontend-scaffold/smoke/` — convention:
